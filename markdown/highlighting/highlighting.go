...
// Highlighting is a markdown.Extender implementation.
var Highlighting = &highlighting{
	options: []Option{},
}

// NewHighlighting returns a new extension with given options.
func NewHighlighting(opts ...Option) markdown.Extender {
	return &highlighting{
		options: opts,
	}
}

// Extend implements markdown.Extender.
func (e *highlighting) Extend(m markdown.Markdown) {

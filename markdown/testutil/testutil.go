...
func DoTestCases(m markdown.Markdown, cases []MarkdownTestCase, t TestingT, opts ...parser.ParseOption) {
...
func DoTestCase(m markdown.Markdown, testCase MarkdownTestCase, t TestingT, opts ...parser.ParseOption) {
	var ok bool

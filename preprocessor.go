...
// A PreprocessorFunc is a function that takes the whole page content and returns a
...
func Preprocessor(f PreprocessorFunc) { preprocessors = append(preprocessors, f) }
